...
public class JDBCTemplate { // 연결과 닫기 만들기
    public static Connection getConnection(){
        ...
        } catch (IOException e) { //연결하는 과정에서 IOException 문제가 생길시 RuntimeException을 던진다
            throw new RuntimeException(e);
        } catch (SQLException e) { //연결하는 과정에서 SQLExection 문제가 생길시 RuntimeException을 던진다
            throw new RuntimeException(e);
        }
        return con;
    }
